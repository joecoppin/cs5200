...
namespace CommSub
{
    public abstract class Conversation
    {
        ...
        public PublicEndPoint RemotEndPoint { get; set; }
        ...
        public virtual void Execute(object context = null)
        {
            ...
            if (UseConverstationQueue)
                CommSubsystem.CloseConversationQueue(ConvId);
        }

        protected virtual bool UseConverstationQueue => true;
        ...
        protected void SetupConversationQueue()
        {
            if (UseConverstationQueue)
            {
                Logger.DebugFormat("Setup conversation queue {0}", ConvId);
        ...
        protected bool IsEnvelopeValid(Envelope env, params Type[] allowedTypes)
        {
            ...
            else
            {
                ...
                {
                    Error = new Error() {Text = "Invalid Type of Message. Allow Types: " +
